...
一点注意事項として、今回読んだ公式ドキュメントは[Vue2](https://jp.vuejs.org/v2/guide/index.html)のものになりますので、Vue3では非推奨や廃止になっているものもある可能性があります。ただVue2の知識も把握しておくと、バージョンアップの変更内容や経緯などは理解しやすくなるかと思います。
